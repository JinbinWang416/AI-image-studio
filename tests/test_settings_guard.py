...
from app.state import settings_store as mod
...
class TestRealPathGuard(unittest.TestCase):
    ...
    def test_frame_classifier(self) -> None:
        ...
        self.assertFalse(mod._frame_is_test(r"E:\proj\app\state\settings_store.py"))
